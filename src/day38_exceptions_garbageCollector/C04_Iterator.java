...
public class C04_Iterator {
    public static void main(String[] args) {
        ...
        /*
            ...
            Bu durumda index olmadigindan elementleri yazdirmak istersek for-each loop kullanabiliriz
        ...
        System.out.println(sayilar); // su anda liste bos. Asagida eleman ekliyoruz.
