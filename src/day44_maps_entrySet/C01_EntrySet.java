...
// {101=Ali-Cem-10-H-MF, 102=Veli-Can-10-M-TM, 103=Ali-Can-11-M-Soz, 104=Ayse-Cem-11-H-TM, 105=Ayse-Han-10-H-MF, 106=Veli-Han-10-H-MF}
        ...
        MapMethodDepo.sinifaGoreListeYazdir(okulMap, 10); // 10. siniftaki ogrencilerin bilgilerini yazdirir.
        System.out.println("");
        MapMethodDepo.sinifaGoreListeYazdir(okulMap, 11); // 11. siniftaki ogrencilerin bilgilerini yazdirir.
