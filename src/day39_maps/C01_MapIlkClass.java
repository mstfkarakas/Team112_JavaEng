...
public class C01_MapIlkClass {
    public static void main(String[] args) {
        ...
        /*
            bir map olusturulurken ve element eklerken,bilgilere sonradan erisimin mumkun olabilmesi icin
            tum elementlerin ayni bilgileri barindirdigindan, ve ayni siralama ile element'e eklendiginden emin olmaliyiz
         */

        Map<Integer,String> okulMap = new HashMap<>();

        okulMap.put(101, "Ali, Cem, 10, H, MF");
        okulMap.put(102, "Veli, Can, 11, H, TM");
        ...
        System.out.println(okulMap.keySet()); //  [101, 102, 103, 104, 105]

        // tum value'lari yazdiralim
        System.out.println(okulMap.values()); // [Ali, Cem, 10, H, MF, Veli, Can, 11, H, TM, Ali, Can, 11, M, Soz, Ayse, Han, 10, H, MF, Veli, Han, 10, H, MF]
